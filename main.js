...
function handlerTab(event, target) {
  ...
  if (target.classList.contains(config.gemClass) && config.gameStates[0]) {
    ...
    if (player.selectedRow == -1) {
      ...
      if (
        (Math.abs(player.selectedRow - row) == 1 && player.selectedCol == col) ||
...
function gemSwitch() {
  ...
  document
    .querySelector("#" + config.gemIdPrefix + "_" + player.posY + "_" + player.posX)
    .classList.add("switch");
  document
    .querySelector("#" + config.gemIdPrefix + "_" + player.posY + "_" + player.posX)
    .setAttribute("dir", "1");
  ...
  document
    .querySelector("#temp")
    .setAttribute("id", config.gemIdPrefix + "_" + player.posY + "_" + player.posX);
